...
def game_over():
    ...
    canvas.create_text(canvas.winfo_width()/2, canvas.winfo_height()/2,
                       ...
                       font=('Tahoma',70), text="GAME OVER", fill="red", tag="gameover")

    canvas.create_text(canvas.winfo_width() / 2, (canvas.winfo_height() / 2)+100,

                       font=('Tahoma', 30), text="Press Enter to Restart", fill="#ccc", tag="restart")
...
def restart_game():
    ...
    # Delete existing snake and food objects
    canvas.delete("snake")
    canvas.delete("food")
